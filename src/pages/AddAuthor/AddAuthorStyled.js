...
export const AddBookAuth = styled(AddBookGenre).attrs({
})``;



export const AddBookTitle = styled.input`
  width: 100%;
  padding: 15px 24px;
  margin-bottom: 20px;
  ...
  background-color: transparent;
  cursor: pointer;
  color: ${(props)=> (props.label? "#000" : "#fff")};
  border-radius: 10px;
  &::placeholder {
    font-family: "Arial";
    font-style: normal;
...
export const LoginFormButton = styled.button.attrs({
  ...
  background:${(props) => (props.variant? "#fff" :"#152540")};
  border-radius: 99px;
  cursor: pointer;
`;
